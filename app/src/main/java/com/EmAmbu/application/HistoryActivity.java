...
import com.EmAmbu.application.historyRecyclerView.HistoryAdapter;
import com.EmAmbu.application.historyRecyclerView.HistoryObject;
...
public class HistoryActivity extends AppCompatActivity {
    ...
    private void payoutRequest() {
        ...
        final Request request = new Request.Builder()
                .url("https://us-central1-simcoder-28aac.cloudfunctions.net/payout")
                .post(body)
